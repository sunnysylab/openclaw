...
<div className="showcase-hero">
  ...
  <div className="showcase-actions">
    ...
    <a href="https://discord.gg/openclaw">Share yours</a>
  </div>
...
<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/openclaw) or [tag @openclaw on X](https://x.com/openclaw).
</Info>
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/openclaw) or [tweet @openclaw](https://x.com/openclaw)
  </Step>
