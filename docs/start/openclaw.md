...
By default, OpenClaw uses `~/.openclaw/workspace` as the agent workspace, and will create it (plus starter `AGENTS.md`, `SOUL.md`, `TOOLS.md`, `IDENTITY.md`, `USER.md`, `HEARTBEAT.md`) automatically on setup/first agent run. `BOOTSTRAP.md` is only created when the workspace is brand new (it should not come back after you delete it). `MEMORY.md` is optional (not auto-created); when present, it is loaded for normal sessions. `OPENCLAW.md` and `CLAUDE.md` are optional first-class policy files when present. Subagent sessions inject `AGENTS.md`, `OPENCLAW.md`, `CLAUDE.md`, `TOOLS.md`, `SOUL.md`, `IDENTITY.md`, and `USER.md`.
