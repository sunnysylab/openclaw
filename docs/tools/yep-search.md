...
1. Create a Yep API account at [https://platform.yep.com/](https://platform.yep.com/)
...
- Pricing: basic searches cost $0.004 per call. See [platform.yep.com](https://platform.yep.com/) for current pricing.
