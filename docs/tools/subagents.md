...
- Sub-agent context only injects `AGENTS.md`, `OPENCLAW.md` (when present), `CLAUDE.md` (when present), `TOOLS.md`, `SOUL.md`, `IDENTITY.md`, and `USER.md` (not `HEARTBEAT.md`, `BOOTSTRAP.md`, or `MEMORY.md`).
