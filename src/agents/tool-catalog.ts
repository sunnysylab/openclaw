...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  {
    id: "sessions_recall",
    label: "sessions_recall",
    description: "Recall and summarize prior sessions",
    sectionId: "sessions",
    profiles: ["coding", "messaging"],
    includeInOpenClawGroup: true,
  },
  {
    id: "skills_manage",
    label: "skills_manage",
    description: "Propose and (with approval) persist a new skill SKILL.md into workspace roots.",
    sectionId: "skills",
    profiles: ["coding", "messaging"],
    includeInOpenClawGroup: true,
  },
