...
const BARE_SESSION_RESET_PROMPT_BASE =
  "A new session was started via /new or /reset. Run your Session Startup sequence. Use any required bootstrap/reference files already in context before rereading files. If a required bootstrap/reference file is missing from context or truncated, read just that file before responding to the user. Then greet the user in your configured persona, if one is provided. Be yourself - use your defined voice, mannerisms, and mood. Keep it to 1-3 sentences and ask what they want to do. If the runtime model differs from default_model in the system prompt, mention the default model. Do not mention internal steps, files, tools, or reasoning.";
