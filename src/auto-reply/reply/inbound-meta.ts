...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  const payload = {
    ...
    sender_principal: safeTrim(ctx.TrustedSenderPrincipal),
  ...
  return [
    ...
    "If sender_principal is present, it is the canonical trusted identity for the current sender. Use it for identity decisions and user references when relevant.",
    "Do not ask the user to disambiguate who they are when sender_principal is present; prefer it over any untrusted sender display name, username, tag, or group nickname.",
