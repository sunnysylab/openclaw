...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "agents.defaults.memorySearch.agentmemo.apiKey",
    targetType: "agents.defaults.memorySearch.agentmemo.apiKey",
    configFile: "openclaw.json",
    pathPattern: "agents.defaults.memorySearch.agentmemo.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "agents.list[].memorySearch.agentmemo.apiKey",
    targetType: "agents.list[].memorySearch.agentmemo.apiKey",
    configFile: "openclaw.json",
    pathPattern: "agents.list[].memorySearch.agentmemo.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
