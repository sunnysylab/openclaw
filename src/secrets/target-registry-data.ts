...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "tools.web.fetch.parallel.apiKey",
    targetType: "tools.web.fetch.parallel.apiKey",
    configFile: "openclaw.json",
    pathPattern: "tools.web.fetch.parallel.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "tools.web.search.parallel.apiKey",
    targetType: "tools.web.search.parallel.apiKey",
    configFile: "openclaw.json",
    pathPattern: "tools.web.search.parallel.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  },
  {
    ...
    targetType: "plugins.entries.parallel.config.webSearch.apiKey",
    configFile: "openclaw.json",
    pathPattern: "plugins.entries.parallel.config.webSearch.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
