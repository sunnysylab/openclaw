...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "channels.feishu.accounts.*.tts.elevenlabs.apiKey",
    targetType: "channels.feishu.accounts.*.tts.elevenlabs.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.feishu.accounts.*.tts.elevenlabs.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.feishu.accounts.*.tts.openai.apiKey",
    targetType: "channels.feishu.accounts.*.tts.openai.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.feishu.accounts.*.tts.openai.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
