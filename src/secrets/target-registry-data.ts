...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "plugins.entries.aimlapi.config.webSearch.apiKey",
    targetType: "plugins.entries.aimlapi.config.webSearch.apiKey",
    configFile: "openclaw.json",
    pathPattern: "plugins.entries.aimlapi.config.webSearch.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
