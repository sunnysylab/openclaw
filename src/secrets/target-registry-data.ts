...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "plugins.entries.brightdata.config.webSearch.apiKey",
    targetType: "plugins.entries.brightdata.config.webSearch.apiKey",
    configFile: "openclaw.json",
    pathPattern: "plugins.entries.brightdata.config.webSearch.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
