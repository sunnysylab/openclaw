...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "channels.discord.accounts.*.voice.tts.deepgram.apiKey",
    targetType: "channels.discord.accounts.*.voice.tts.deepgram.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.discord.accounts.*.voice.tts.deepgram.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.discord.voice.tts.deepgram.apiKey",
    targetType: "channels.discord.voice.tts.deepgram.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.discord.voice.tts.deepgram.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "messages.tts.deepgram.apiKey",
    targetType: "messages.tts.deepgram.apiKey",
    configFile: "openclaw.json",
    pathPattern: "messages.tts.deepgram.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
