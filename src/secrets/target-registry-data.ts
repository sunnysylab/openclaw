...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "tools.web.search.you.apiKey",
    targetType: "tools.web.search.you.apiKey",
    configFile: "openclaw.json",
    pathPattern: "tools.web.search.you.apiKey",
  ...
  {
    id: "tools.web.fetch.you.apiKey",
    targetType: "tools.web.fetch.you.apiKey",
    configFile: "openclaw.json",
    pathPattern: "tools.web.fetch.you.apiKey",
    secretShape: "secret_input",
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "tools.web.research.apiKey",
    targetType: "tools.web.research.apiKey",
    configFile: "openclaw.json",
    pathPattern: "tools.web.research.apiKey",
    secretShape: "secret_input",
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
