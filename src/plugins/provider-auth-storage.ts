...
export const AVIAN_DEFAULT_MODEL_REF = "avian/deepseek/deepseek-v3.2";
...
export async function setAvianApiKey(
  key: SecretInput,
  agentDir?: string,
  options?: ApiKeyStorageOptions,
) {
  upsertAuthProfile({
    ...
    credential: buildApiKeyCredential("avian", key, undefined, options),
    agentDir: resolveAuthAgentDir(agentDir),
  });
}
