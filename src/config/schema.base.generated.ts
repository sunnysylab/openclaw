...
export const GENERATED_BASE_CONFIG_SCHEMA = {
  ...
  uiHints: {
    ...
    "channels.bluebubbles.allowPrivateNetwork": {
      label: "BlueBubbles Allow Private Network",
      help: "Allows BlueBubbles requests to target localhost/LAN/private-network server URLs. Enable this when the BlueBubbles server runs on the same machine, behind a trusted reverse proxy, or on a local/private subnet.",
      tags: ["access", "network", "channels"],
    },
