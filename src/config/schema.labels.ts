...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "approvals.http": "HTTP Approval Forwarding",
  "approvals.http.enabled": "Forward HTTP Approvals",
  "approvals.http.mode": "HTTP Approval Forwarding Mode",
  "approvals.http.agentFilter": "HTTP Approval Agent Filter",
  "approvals.http.sessionFilter": "HTTP Approval Session Filter",
  "approvals.http.targets": "HTTP Approval Forwarding Targets",
  "approvals.http.targets[].channel": "HTTP Approval Target Channel",
  "approvals.http.targets[].to": "HTTP Approval Target Destination",
  "approvals.http.targets[].accountId": "HTTP Approval Target Account ID",
  "approvals.http.targets[].threadId": "HTTP Approval Target Thread ID",
  "approvals.httpPolicy": "HTTP Approval Policy",
  "approvals.httpPolicy.security": "HTTP Security Mode",
  "approvals.httpPolicy.ask": "HTTP Ask Mode",
  "approvals.httpPolicy.askFallback": "HTTP Ask Fallback",
  "approvals.httpPolicy.agents": "HTTP Per-Agent Policy",
  "approvals.httpPolicy.allowlist": "HTTP URL Allowlist",
