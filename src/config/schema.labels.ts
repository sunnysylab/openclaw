...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "cron.criticLoop": "Cron Critic Loop",
  "cron.criticLoop.enabled": "Cron Critic Loop Enabled",
  "cron.criticLoop.mode": "Cron Critic Loop Mode",
  "cron.criticLoop.minScore": "Cron Critic Loop Minimum Score",
  "cron.criticLoop.defaultSpec": "Cron Critic Loop Default Spec",
  "cron.criticLoop.redTeamSeverityThreshold": "Cron Critic Loop Red-Team Severity Threshold",
  hooks: "Hooks",
