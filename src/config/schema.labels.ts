...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.guardModel": "Guard Model",
  "agents.defaults.guardModel.primary": "Guard Model",
  ...
  "agents.defaults.inputGuardModel": "Input Guard Model",
  "agents.defaults.inputGuardPolicy": "Input Guard Policy",
  "agents.defaults.inputGuardPolicy.*.enabledLabels": "Input Enabled Guard Labels",
  "agents.defaults.inputGuardPolicy.*.enabledCategories": "Input Enabled Guard Categories",
  "agents.defaults.inputGuardModel.primary": "Input Guard Model",
  "agents.defaults.inputGuardModel.fallbacks": "Input Guard Model Fallbacks",
  "agents.defaults.inputGuardModelAction": "Input Guard Model Action",
  "agents.defaults.inputGuardModelOnError": "Input Guard Model On Error",
  "agents.defaults.inputGuardModelMaxInputChars": "Input Guard Model Max Input Characters",
  "agents.defaults.outputGuardModel": "Output Guard Model",
  "agents.defaults.outputGuardPolicy": "Output Guard Policy",
  "agents.defaults.outputGuardPolicy.*.enabledLabels": "Output Enabled Guard Labels",
  "agents.defaults.outputGuardPolicy.*.enabledCategories": "Output Enabled Guard Categories",
  "agents.defaults.outputGuardModel.primary": "Output Guard Model",
  "agents.defaults.outputGuardModel.fallbacks": "Output Guard Model Fallbacks",
  "agents.defaults.outputGuardModelAction": "Output Guard Model Action",
  "agents.defaults.outputGuardModelOnError": "Output Guard Model On Error",
  "agents.defaults.outputGuardModelMaxInputChars": "Output Guard Model Max Input Characters",
  "agents.defaults.models.*.guardTaxonomy": "Guard Taxonomy",
  "agents.defaults.models.*.guardTaxonomy.labels": "Guard Labels",
  "agents.defaults.models.*.guardTaxonomy.categories": "Guard Categories",
