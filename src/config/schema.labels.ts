...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.fs.allowedPaths": "FS tools allowlist",
  "tools.fs.denyPaths": "FS tools denylist",
  "tools.subagents.fs.workspaceOnly": "Subagent FS: workspace-only ceiling",
  "tools.subagents.fs.allowedPaths": "Subagent FS: allowlist ceiling",
  "tools.subagents.fs.denyPaths": "Subagent FS: denylist ceiling",
  "tools.sessions_spawn.fsPolicy": "sessions_spawn FS policy tightening",
