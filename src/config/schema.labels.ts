...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.restart": "Gateway Restart Recovery",
  "gateway.restart.sessionRecovery": "Restart Session Recovery",
  "gateway.restart.cronRetryOnInterrupt": "Restart Cron Retry on Interrupt",
  "gateway.restart.readinessGate": "Restart Readiness Gate",
  "gateway.restart.readinessGateThreshold": "Restart Readiness Gate Threshold",
  "gateway.restart.drainQueueMessages": "Restart Drain Queue Messages",
  "gateway.restart.manifestPath": "Restart Manifest Path",
