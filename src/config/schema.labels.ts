...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "diagnostics.otel.enrichment": "OpenTelemetry Trace Enrichment",
  "diagnostics.otel.enrichment.enabled": "Trace Enrichment Enabled",
  "diagnostics.otel.enrichment.fullTraceTree": "Full Trace Tree Enabled",
  "diagnostics.otel.enrichment.includeContent": "Include Content Previews in Traces",
