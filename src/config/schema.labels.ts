...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "skills.policy.globalEnabled": "Global Enabled Skills",
  "skills.policy.agentOverrides": "Agent Skill Overrides",
  "skills.policy.agentOverrides.*.enabled": "Agent Enabled Skills",
  "skills.policy.agentOverrides.*.disabled": "Agent Disabled Skills",
