...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.list[].tools.sessions.visibility": "Per-Agent Session Visibility Override",
  "agents.list[].tools.agentToAgent.enabled": "Per-Agent Agent-to-Agent Toggle",
  "agents.list[].tools.agentToAgent.allow": "Per-Agent Agent-to-Agent Target Allowlist",
