...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.graph.dbPath": "Graph DB Path",
  "memory.graph.fts": "Graph FTS Enabled",
  "memory.graph.anchorBoost": "Graph Anchor Boost",
  "memory.graph.transitionBoost": "Graph Transition Boost",
  "memory.graph.autoReinforce": "Graph Auto-Reinforce",
  "memory.graph.fallbackToBuiltin": "Graph Fallback to Builtin",
  auth: "Auth",
