...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.heartbeat.schedule": "Heartbeat Schedule",
  "agents.defaults.heartbeat.schedule[].start": "Schedule Window Start",
  "agents.defaults.heartbeat.schedule[].end": "Schedule Window End",
  "agents.defaults.heartbeat.schedule[].every": "Schedule Window Interval",
  "agents.list[].heartbeat.schedule": "Agent Heartbeat Schedule",
