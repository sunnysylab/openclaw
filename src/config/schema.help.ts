...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.imageGenerationModel.timeoutMs":
    "Request timeout in milliseconds for image generation. Passed to providers to limit how long a single generation request may take. Default: provider-specific (typically 60 000 ms).",
