...
export async function generateVoiceResponse(
  ...
  const bindings = rawCfg.bindings as Array<{ agentId?: string; match?: { channel?: string } }> | undefined;
  const agents = (rawCfg.agents as Record<string, unknown>)?.list as Array<{ id: string; default?: boolean }> | undefined;
  if (bindings) {
