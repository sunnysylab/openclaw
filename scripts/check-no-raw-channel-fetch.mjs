...
const allowedRawFetchCallsites = new Set([
  ...
  "extensions/mattermost/src/mattermost/client.ts:259",
  "extensions/mattermost/src/mattermost/monitor.ts:230",
  "extensions/mattermost/src/mattermost/probe.ts:27",
  "extensions/minimax/oauth.ts:68",
  "extensions/minimax/oauth.ts:109",
  "extensions/msteams/src/graph.ts:39",
  "extensions/nextcloud-talk/src/room-info.ts:92",
  "extensions/nextcloud-talk/src/send.ts:104",
  "extensions/nextcloud-talk/src/send.ts:187",
  "extensions/qwen-portal-auth/oauth.ts:38",
  "extensions/qwen-portal-auth/oauth.ts:72",
