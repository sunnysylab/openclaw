...
async function main() {
  ...
  const assertionCase = getCaseAssertions('success-approve');
  ...
  console.log('ASSERTION_PASS demo-run-success');
...
main().catch(error => {
  console.error('ASSERTION_FAIL demo-run-success');
