...
async function main() {
  ...
  const assertionCase = getCaseAssertions('failed-retry-success');
  ...
  console.log('ASSERTION_PASS demo-run-retry');
...
main().catch(error => {
  console.error('ASSERTION_FAIL demo-run-retry');
