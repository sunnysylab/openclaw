...
export const zh_CN: TranslationMap = {
  ...
  usage: {
    page: {
      subtitle: "查看令牌流向、会话峰值时间，以及哪些因素推动了成本。",
    },
    common: {
      emptyValue: "—",
      unknown: "未知",
    ...
    query: {
      ...
      inRange: "范围内共有 {total} 个会话",
      tip: "提示：使用筛选器或点击柱状图以细化天数范围。",
    },
    export: {
      label: "导出",
      sessionsCsv: "会话 CSV",
    ...
    empty: {
      title: "先选择日期范围",
      subtitle: "加载使用数据后，你可以比较成本、检查会话并深入查看时间线，而无需离开仪表板。",
    ...
    overview: {
      ...
      avgCost: "每条消息平均费用",
      avgCostHint: "当提供商上报费用时，显示每条消息的平均费用。",
      avgCostHintMissing:
        "当提供商上报费用时，显示每条消息的平均费用。此范围内部分或全部会话缺少费用数据。",
      acrossMessages: "共 {count} 条消息",
      sessions: "会话",
      sessionsHint: "该范围内不同会话的数量。",
      sessionsInRange: "范围内共 {count} 个",
      throughput: "吞吐量",
      throughputHint: "吞吐量表示活跃时间内每分钟处理的令牌数。越高越好。",
