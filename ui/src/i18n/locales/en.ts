...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    console: "Visual run control console.",
    trace: "Call chain and run trace visualization.",
    promptInspector: "System prompt composition and metadata.",
    security: "Tool policies, skill gating, plugin trust.",
