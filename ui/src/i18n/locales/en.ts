...
export const en: TranslationMap = {
  ...
  cron: {
    ...
    form: {
      ...
      script: "Run script directly (no AI)",
      systemEventHelp:
      ...
      scriptHelp: "Runs an executable file directly — no AI session or token cost.",
      scriptCommand: "Script command",
      scriptCommandPlaceholder: "~/scripts/backup.sh",
      scriptCommandHelp: "Path to the executable. Supports ~, absolute, or relative to OC home.",
      scriptArgs: "Arguments",
      scriptArgsPlaceholder: "One argument per line",
      scriptArgsHelp: "Arguments passed as an array (not a shell string — no injection risk).",
      scriptEnv: "Environment variables",
      scriptEnvPlaceholder: "KEY=value\nANOTHER=val",
      scriptEnvHelp: "Extra environment variables merged onto the process environment.",
      scriptCwd: "Working directory",
      scriptCwdPlaceholder: "~/scripts (optional)",
      scriptCwdHelp: "Optional working directory override. Defaults to OC home.",
    ...
    errors: {
      ...
      scriptEnvMalformed: "Malformed env entries (expected KEY=VALUE)",
    },
  },
};
