...
- Gateway/pairing: support multi-role and subset scope validation in device bootstrap tokens, and expand the default pairing profile to include all standard node and operator scopes for new pairings. (#57228)
