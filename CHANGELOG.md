...
- Agents/session startup: make bare `/new` and `/reset` prompts explicitly tell agents to rerun workspace startup files and avoid reboot/setup narration before greeting.
