...
- Agents/skills sandbox path prompts: prefer workspace-relative skill locations for workspace-local skills so sandboxed embedded agents can open synced skill files from `/workspace` instead of host-only paths.
