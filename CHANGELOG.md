...
- Inworld: add Inworld as a built-in TTS speech provider with streaming synthesis, voice listing, and telephony support. Models: inworld-tts-1.5-max, inworld-tts-1.5-mini.
