...
- Messages/TTS: add xAI as a TTS provider option in `messages.tts.provider`, supporting the native xAI TTS API (`api.x.ai/v1/tts`) with five voices (eve, ara, rex, sal, leo) and output supports multiple codecs.
