...
- Polls: treat zero or negative numeric poll durations as absent so `hasPollCreationParams` does not infer poll intent from `pollDurationHours: 0` alone. (#51830)
