...
- Android/gateway onboarding: reject insecure remote cleartext gateway endpoints from manual entry, setup codes, and discovery while still allowing local loopback and Android Emulator bridge flows for device-local development.
